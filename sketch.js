...
var gameoversound,carambiteswaashsound

function preload(){
  
  knifeImage = loadImage("5.png");
  monsterImage = loadAnimation("alien1.png","alien2.png")
  fruit1 = loadImage("0.png");
  fruit2 = loadImage("1.png");
  fruit3 = loadImage("2.png");
  fruit4 = loadImage("3.png");
  gameOverImage = loadImage("gameover.png")

  //carregue o som aqui
  gameoversound=loadSound("gameover.mp3")
  carambiteswaashsound=loadSound("knifeSwoosh.mp3")
}
...
function Monster(){
  if(World.frameCount%200===0){
    monster=createSprite(Math.round(random(200,1000)),200,20,20);
